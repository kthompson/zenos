        ...
        public virtual bool Compile(IMethodContext context, InstructionChain chain)
        {
            ...
            if (ins.SourceInstruction.OpCode.OpCodeType == OpCodeType.Macro)
            {
                switch (ins.Code)
                {
                    ...
                    case InstructionCode.CilLdarg_3:
                        Simplify(ins, InstructionCode.ZilLoad, context.Parameters[ins.Code - InstructionCode.CilLdarg_0]);
                        break;
                    ...
                    case InstructionCode.CilLdloc_3:
                        Simplify(ins, InstructionCode.ZilLoad, context.Locals[ins.Code - InstructionCode.CilLdloc_0]);
                        break;

                    case InstructionCode.CilLdarg_S:
                        Simplify(ins, InstructionCode.ZilLoad, context.Parameters[(sbyte) ins.Operand0]);
                        break;

                    case InstructionCode.CilLdloc_S:
                        Simplify(ins, InstructionCode.ZilLoad, context.Locals[(sbyte) ins.Operand0]);
                        break;
                    ...
                    case InstructionCode.CilStloc_3:
                        Simplify(ins, InstructionCode.ZilStore, context.Locals[ins.Code - InstructionCode.CilStloc_0]);
                        break;

                    case InstructionCode.CilStarg_S:
                        Simplify(ins, InstructionCode.ZilStore, context.Parameters[(sbyte) ins.Operand0]);
                        break;
                    case InstructionCode.CilStloc_S:
                        Simplify(ins, InstructionCode.ZilStore, context.Locals[(sbyte) ins.Operand0]);
                        break;
                    ...
                    case InstructionCode.CilLdc_I4_8:
                        Simplify(ins, InstructionCode.ZilLoad, ins.Code - InstructionCode.CilLdc_I4_0);
                        break;

                    case InstructionCode.CilLdc_I4_S:
                        Simplify(ins, InstructionCode.ZilLoad, (int) (sbyte) ins.Operand0);
                        break;
            ...
            switch (ins.Code)
            {
                case InstructionCode.CilLdc_I4:
                    Simplify(ins, InstructionCode.ZilLoad, (int)ins.Operand0);
                    break;

                case InstructionCode.CilLdc_I8:
                    Simplify(ins, InstructionCode.ZilLoad, (long)ins.Operand0);
                    break;
            }
