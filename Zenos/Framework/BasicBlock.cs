...
namespace Zenos.Framework
{
    public class BasicBlocks : IEnumerable<BasicBlock>
    {
        ...
        public BasicBlock GetOrCreateByTarget(IInstruction instruction) =>
    ...
    public class BasicBlock : IEnumerable<IInstruction>, IComparable<BasicBlock>
    {
        ...
        public BasicBlock(IInstruction instruction)
        {
